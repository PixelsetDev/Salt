    ...
    <ScrollView className={`body`}>
      ...
      <View>
        <View className="p-std gap-lg grid">
          <WarningBox
            message={
              'This Cookie Policy comes into force on 19th July 2026. Until that date, the current Cookie Policy available at https://pixelset.dev/legal/cookies/?s=ourcookbook apply.'
            }></WarningBox>
